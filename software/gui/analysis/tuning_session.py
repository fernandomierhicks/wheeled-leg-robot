...
TRIALS_CSV_FIELDS = [
    ...
    "max_hip_l_current_a", "max_hip_r_current_a", "max_wm_l_vel_turns_s", "max_wm_r_vel_turns_s",
...
def trial_row(stage: str, gains: dict, eval_result: dict, accepted: bool, step_size: float,
    ...
    return {
        ...
        "max_hip_l_current_a": m.get("max_hip_l_current_a"),
        "max_hip_r_current_a": m.get("max_hip_r_current_a"),
