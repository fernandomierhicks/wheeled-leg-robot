...
class RawDataTab(QWidget):
    ...
    def _build_imu_tab(self, tabs: QTabWidget):
        ...
        r = self._add_row(g, r, ("standup_state",       "—"),  ("",                    ""))
    ...
    def _build_hip_tab(self, tabs: QTabWidget):
        ...
        r = self._add_row(g, r, ("hip_l_torque_nm",     "—"),  ("hip_r_torque_nm",     "—"))
    ...
    def _on_packet(self, info: dict):
        ...
        self._set("standup_state",       str(f.get("standup_state", "—")))
        ...
        self._set("hip_l_torque_nm",     f"{f.get('hip_l_torque_nm', 0.0):+.4f}")
        self._set("hip_r_torque_nm",     f"{f.get('hip_r_torque_nm', 0.0):+.4f}")
