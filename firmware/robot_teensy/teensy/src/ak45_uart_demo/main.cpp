...
void setup() {
    ...
    Serial.println("AK45 UART hello-world — hip motors on Serial2 (pin 8/7) + Serial3 (pin 14/15)");
...
static void print_motor(const char* label, const AK45Uart& ak) {
    ...
    Serial.print(":  E=");   Serial.print(s.e_angle_rad, 4);
    Serial.print(" rad  M="); Serial.print(s.m_angle_rad, 4);
    Serial.print(" rad  RAW="); Serial.println(s.raw);
}
