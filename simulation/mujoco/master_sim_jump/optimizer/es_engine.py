...
Usage
-----
    from master_sim_jump.optimizer.search_space import LQR_SPACE
    from master_sim_jump.optimizer.es_engine import ESOptimizer
...
from master_sim_jump.optimizer.search_space import SearchSpace
...
class ESOptimizer:
    ...
    def _log_eval(self, candidate: dict, result: dict, label: str, gen: int) -> None:
        ...
        if self.csv_path is None:
            return
        from master_sim_jump.optimizer.run_log import log_run
