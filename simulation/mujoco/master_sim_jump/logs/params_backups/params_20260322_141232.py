...
class SuspensionGains:
    ...
    K_s: float = 19.7959               # [N·m/rad] spring stiffness
    B_s: float = 0.077031              # [N·m·s/rad] damping
    K_roll: float = 5.47353            # [rad/rad] roll proportional
    D_roll: float = 0.101163           # [rad·s/rad] roll rate damping
