...
class SuspensionGains:
    ...
    K_s: float = 8.25628               # [N·m/rad] spring stiffness
    B_s: float = 0.0454207              # [N·m·s/rad] damping
    K_roll: float = 75.5951            # [rad/rad] roll proportional
    D_roll: float = 1.3799           # [rad·s/rad] roll rate damping
