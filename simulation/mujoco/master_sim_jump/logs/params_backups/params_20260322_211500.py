...
class SuspensionGains:
    ...
    K_s: float = 14.7912               # [N·m/rad] spring stiffness
    B_s: float = 0.220195              # [N·m·s/rad] damping
    K_roll: float = 67.8917            # [rad/rad] roll proportional
    D_roll: float = 0.753029           # [rad·s/rad] roll rate damping
