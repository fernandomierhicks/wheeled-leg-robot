...
class SuspensionGains:
    ...
    K_s: float = 67.644               # [N·m/rad] spring stiffness
    B_s: float = 0.0810507              # [N·m·s/rad] damping
    K_roll: float = 8.09089            # [rad/rad] roll proportional
    D_roll: float = 0.0238294           # [rad·s/rad] roll rate damping
