...
class LQRGains:
    ...
    Q_pitch: float = 8.54548
    Q_pitch_rate: float = 0.00371663
    Q_vel: float = 0.00152656
    R: float = 63.2117
...
class VelocityPIGains:
    ...
    theta_ref_rate_limit: float = 20.0  # [rad/s]  How fast can commanded lean angle change every tick (larger number = more aggresive)
...
class SuspensionGains:
    ...
    K_s: float = 4.263               # [N·m/rad] spring stiffness
    B_s: float = 0.1538              # [N·m·s/rad] damping
    K_roll: float = 307            # [rad/rad] roll proportional
    D_roll: float = 0.4372           # [rad·s/rad] roll rate damping
