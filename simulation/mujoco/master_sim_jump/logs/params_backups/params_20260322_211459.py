...
class SuspensionGains:
    ...
    K_s: float = 98.3906               # [N·m/rad] spring stiffness
    B_s: float = 0.382825              # [N·m·s/rad] damping
    K_roll: float = 0.0044292            # [rad/rad] roll proportional
    D_roll: float = 0.277849           # [rad·s/rad] roll rate damping
