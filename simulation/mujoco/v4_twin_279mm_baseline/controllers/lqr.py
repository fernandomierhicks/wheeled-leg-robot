...
from v4_twin_279mm_baseline.params import RobotGeometry, LQRGains, WheelMotorParams
from v4_twin_279mm_baseline.physics import solve_ik, get_equilibrium_pitch
...
def compute_lqr_gain(q_hip: float, robot: RobotGeometry,
    ...
    m_b = robot.body_mass_excluding_wheels + 2 * m_spring
    m_w = 2 * robot.m_wheel
