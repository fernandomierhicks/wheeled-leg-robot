...
from v4_twin_279mm_baseline.optimizer.common import (
...
def _resolve_search_space(scenario_name: str):
    ...
    from v4_twin_279mm_baseline.scenarios import SCENARIOS
    from v4_twin_279mm_baseline.optimizer.search_space import SPACE_BY_GROUP, INTEGRATED_SPACE
