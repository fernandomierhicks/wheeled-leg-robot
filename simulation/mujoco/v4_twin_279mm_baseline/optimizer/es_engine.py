...
Usage
-----
    from v4_twin_279mm_baseline.optimizer.search_space import LQR_SPACE
    from v4_twin_279mm_baseline.optimizer.es_engine import ESOptimizer
...
from v4_twin_279mm_baseline.optimizer.search_space import SearchSpace
...
class ESOptimizer:
    ...
    def _log_eval(self, candidate: dict, result: dict, label: str, gen: int) -> None:
        ...
        if self.csv_path is None:
            return
        from v4_twin_279mm_baseline.optimizer.run_log import log_run
