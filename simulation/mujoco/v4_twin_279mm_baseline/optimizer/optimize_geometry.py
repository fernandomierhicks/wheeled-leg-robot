...
Usage:
    python -m v4_twin_279mm_baseline.optimizer.optimize_geometry --hours 4
    python -m v4_twin_279mm_baseline.optimizer.optimize_geometry --iters 100 --workers 4
    python -m v4_twin_279mm_baseline.optimizer.optimize_geometry --iters 20 --no-save   # dry run
"""
import argparse
import math
import multiprocessing

from v4_twin_279mm_baseline.optimizer.search_space import SearchSpace, ParamSpec
...
class EvalWithGeometry:
    ...
    def __call__(self, candidate: dict) -> dict:
        ...
        from v4_twin_279mm_baseline.scenarios import evaluate
        from v4_twin_279mm_baseline.physics import (auto_stroke_angles,
...
def main():
    from v4_twin_279mm_baseline.optimizer.es_engine import ESOptimizer, ESConfig
    ...
    from v4_twin_279mm_baseline.optimizer.progress_ui import ProgressUI
    ui = ProgressUI(
