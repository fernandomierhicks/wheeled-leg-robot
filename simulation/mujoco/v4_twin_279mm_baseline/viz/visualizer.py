...
def _compute_com_pair(data, box_bid, robot, q_hip_avg_rad, m_spring):
    ...
    """
    import numpy as _np
    from v4_twin_279mm_baseline.physics import compute_com_x_body_frame
    try:
...
def sandbox_world():
    ...
    from v4_twin_279mm_baseline.scenarios.base import WorldConfig
    return WorldConfig(
...
def replay_show(telemetry: dict, metrics: dict, scenario_name: str,
    ...
    from v4_twin_279mm_baseline.physics import get_equilibrium_pitch
    ...
    if len(v_batt) > 0:
        from v4_twin_279mm_baseline.defaults import DEFAULT_PARAMS as _dp
...
def sandbox(rng_seed: int = 0):
    ...
    from v4_twin_279mm_baseline.physics import get_equilibrium_pitch
    from v4_twin_279mm_baseline.controllers.jump import RobotMode
