...
class SuspensionGains:
    ...
    K_s: float = 1.86373               # [N·m/rad] spring stiffness
    B_s: float = 1.66284              # [N·m·s/rad] damping
    K_roll: float = 98.5505            # [rad/rad] roll proportional
    D_roll: float = 0.341626           # [rad·s/rad] roll rate damping
