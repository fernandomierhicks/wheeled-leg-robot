...
class SuspensionGains:
    ...
    K_s: float = 0.168118               # [N·m/rad] spring stiffness
    B_s: float = 4.30375              # [N·m·s/rad] damping
    K_roll: float = 39.8377            # [rad/rad] roll proportional
    D_roll: float = 94.7142           # [rad·s/rad] roll rate damping
