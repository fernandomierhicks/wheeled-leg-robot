...
class SuspensionGains:
    ...
    K_s: float = 75.2962               # [N·m/rad] spring stiffness
    B_s: float = 1.04778              # [N·m·s/rad] damping
    K_roll: float = 10.2757            # [rad/rad] roll proportional
    D_roll: float = 0.00359293           # [rad·s/rad] roll rate damping
