...
class SuspensionGains:
    ...
    K_s: float = 99.1948               # [N·m/rad] spring stiffness
    B_s: float = 1.42732              # [N·m·s/rad] damping
    K_roll: float = 8.02157            # [rad/rad] roll proportional
    D_roll: float = 0.00564596           # [rad·s/rad] roll rate damping
