...
class LQRGains:
    ...
    Q_pitch: float = 0.0436227
    Q_pitch_rate: float = 0.0492612
    Q_vel: float = 1.1401e-04
    R: float = 1.56531
...
class SuspensionGains:
    ...
    K_s: float = 36.8271               # [N·m/rad] spring stiffness
    B_s: float = 0.438329              # [N·m·s/rad] damping
    K_roll: float = 19.7704            # [rad/rad] roll proportional
    D_roll: float = 0.0385145           # [rad·s/rad] roll rate damping
