...
class SuspensionGains:
    ...
    K_s: float = 87.0995               # [N·m/rad] spring stiffness
    B_s: float = 4.24384              # [N·m·s/rad] damping
    K_roll: float = 46.0669            # [rad/rad] roll proportional
    D_roll: float = 0.411311           # [rad·s/rad] roll rate damping
