...
class LQRGains:
    ...
    Q_pitch: float = 0.0296996
    Q_pitch_rate: float = 0.0246277
    Q_vel: float = 0.00249705
    R: float = 45.3179
...
class SuspensionGains:
    ...
    K_s: float = 57.8472               # [N·m/rad] spring stiffness
    B_s: float = 0.137537              # [N·m·s/rad] damping
    K_roll: float = 0.00111598            # [rad/rad] roll proportional
    D_roll: float = 0.663264           # [rad·s/rad] roll rate damping
