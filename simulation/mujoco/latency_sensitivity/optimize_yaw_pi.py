"""optimize_yaw_pi.py — YawPI Gain Optimizer (KP_YAW / KI_YAW search)
...
def _eval_worker(args):
    ...
    # Fix LQR and VelocityPI gains; search only over YawPI
    ...
    scenarios.YAW_PI_KP_GAIN    = kp_yaw
    scenarios.YAW_PI_KI_GAIN    = ki_yaw
...
def main():
    ap = argparse.ArgumentParser(
        description="YawPI gain optimizer (KP_YAW / KI_YAW via evolutionary strategy).",
